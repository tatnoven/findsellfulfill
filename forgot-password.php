        ...
        <div id="main-content">
            <div class="container">
                ...
                if(isset($_GET["error"]) && !empty($_GET["error"])){
                            ...
                            if($_GET["error"]==3){
                                echo '<p class="alert-success">Reset link has been send at your Email_Id!</p>';
                            }
                             if($_GET["error"]==4){
                                echo '<p class="alert-success">Email Not Exits!</p>';
                            }
                        }
                ?>
                    
                <form action="forgot-process.php" method="POST" style="margin-top:20px;">
                    <input type="email" name="email" placeholder="Your Email"/>
                    <input type="submit" class="btn-normal" value="Forgot Password"/>
